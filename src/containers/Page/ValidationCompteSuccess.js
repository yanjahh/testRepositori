          ...
          <div className="isoFormContent">
            <div className="isoLogoWrapper">
              <Link to="/Validation/Compte">
                ...
                <br/><br/>
              <IntlMessages id="page.validationsuccessTitle"/>
              </Link>
            </div>
            ...
            <div className="isoFormHeadText">
              ...
              <p>
                <IntlMessages id="page.validationSuccessDescription" />
              </p>
              <br/>
            </div>
            ...
            <div className="isoResetPassForm">
              ...
              <div className="isoInputWrapper isoOtherLogin">
                ...
                <Link to="/dashboard/InformationsCompte"> <IntlMessages id="page.ValidationSuccessSave" />
                 </Link>
                </Button>
              </div>
            </div>
